    ...
    <Layout>
      ...
      <section className="py-20 md:py-28" ref={ref}>
        <div className="container-wide"><div className="max-w-3xl mx-auto reveal space-y-6">
          <p className="text-foreground/70 leading-relaxed">As mandated by the Bar Council of India and the University Grants Commission, Ishan Institute of Law has established a comprehensive Grievance Redressal Mechanism. We are committed to maintaining a transparent, fair, and time-bound process for addressing concerns related to academic matters, administrative services, and campus facilities.</p>
          <h2 className="text-lg font-display font-bold text-foreground">Redressal Process</h2>
          ...
          <div className="p-5 rounded-xl border bg-section-alt">
            ...
            <p className="text-sm text-foreground/70">Email: <a href="mailto:registrar@ishan.ac" className="text-navy font-semibold">registrar@ishan.ac</a></p>
