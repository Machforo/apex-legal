...
export default function ExitIntentPopup() {
  ...
  useEffect(() => {
    ...
    const hasInteracted = localStorage.getItem("Ishan Law Institute_exit_intent_interacted");
  ...
  const handleDismiss = () => {
    setIsVisible(false);
    localStorage.setItem("Ishan Law Institute_exit_intent_interacted", "true");
  };
